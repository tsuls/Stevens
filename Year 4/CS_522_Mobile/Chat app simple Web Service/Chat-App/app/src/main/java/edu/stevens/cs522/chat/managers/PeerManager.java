...
public class PeerManager extends Manager<Peer> {
    ...
    public void getPeerAsync(String name, IContinue<Cursor> callback) {
        ...
        asyncContentResolver.queryAsync(PeerContract.CONTENT_URI, null, PeerContract.NAME + "=?", new String[]{name}, null, callback);
    }
    ...
    public void updateAsync(String selection, String[] args, IContinue<Long> callback) {
       // ContentValues values = new ContentValues();
        asyncContentResolver.updateAsync(PeerContract.CONTENT_URI, selection, args);
    }
