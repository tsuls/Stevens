...
public class ViewPeersActivity extends Activity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  startManagingCursor(cursor);
        ...
        peerAdapter = new SimpleCursorAdapter(this, android.R.layout.simple_expandable_list_item_2, cursor, new String[]{
                PeerContract.NAME, PeerContract.TIMESTAMP, PeerContract.ADDRESS
