...
public abstract class PigPlayer 
{
    ...
    /**
     * Displays a message when a player rolls four 1s
     * 
     */
    ...
    /**
     * Displays a message when a player rolls three 1s
     * 
     */
    ...
    /**
     * Displays a message when a player rolls two 1s
     * 
     */
    ...
    /**
     * Displays a message when a player rolls one 1
     * 
     */
    protected void displayGotOneOne()//
    {
    	System.out.println(name + " rolled One 1!");
    ...
    /**
     * This method implements the rules of the Pig game with 3 normal dice and one Fixed die by using a count of rolls
     */
